...
<html lang="en">
  <head>
    ...
    <title>Pendaftaran Siswa Baru RA Nurul Hijrah</title>
  ...
  <!-- Global site tag (gtag.js) - Google Analytics -->
	...
	<style>body{background-color:#c2c5aa;}
...
.btn{
  ...
  <img src="img/logo.png" width="30%" style="margin-top:2%" \>

	<br \><br \>
			<div class="container">
					<div style="color:white">
					<label>Pendaftaran Akun Peserta Didik Baru RA Nurul Hijrah</label><br \>
                ...
                <form method="post">
                    ...
                    <a class="btn btn-info text-light" href="login.php">Kembali</a>
                </form>
